...
if __name__ == '__main__':
    ...
    #parser.add_argument('--load', type=str, default='logs/ourtrain_split2.log/best_model.pt')
    parser.add_argument('--load', type=str, default='logs/pascal_ourtrain_PR_resnet101_split2.log/best_model.pt')
    ...
    with open('pascal_test_split2.txt','a') as f:
