...
import sys
sys.path.append("/media/meng2/disk11/ZRT/PycharmProjects/hsnet-main")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--load', type=str, default='checkpoints/pascal/res50_pas/res50_pas_fold0/best_model.pt')
    ...
    with open('test_split0.txt','a') as f:
