...
def test(model, model_aux, dataloader, nshot):
    ...
    for class_ in class_list:
        ...
        for idx, batch in enumerate(dataloader):
            ...
            if QS > 0.3:
                ...
                Image.fromarray(np.uint8(pseudo_label)).convert('L').save(
                    '/media/meng2/disk11/ZRT/PycharmProjects/Datasets_HSN/VOC2012/S-Expansion/split0/Buffer/%s_class%d.png'
        ...
        with open('/media/meng2/disk11/ZRT/PycharmProjects/Datasets_HSN/VOC2012/S-Expansion/split0/pascal_split0_class%d.pkl'%(class_),'wb') as f:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--load_aux', type=str, default='checkpoints/pascal/res50_pas/res50_pas_fold0/best_model.pt')
