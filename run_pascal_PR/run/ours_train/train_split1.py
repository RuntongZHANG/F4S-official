...
def train(epoch, model, dataloader, optimizer, training):
    ...
    for idx, batch in enumerate(dataloader):
        ...
        logit_mask, _, _  = model(batch['query_img'], batch['support_imgs'].squeeze(1), batch['support_masks'].squeeze(1))
    ...
    miou, fb_iou, _, _  = average_meter.compute_iou()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--benchmark', type=str, default='pascal_ourtrain', choices=['pascal', 'coco', 'fss'])
    parser.add_argument('--logpath', type=str, default='pascal_ourtrain_PR_resnet101_split1')
